      ...
      <header class="custom-header">
        <div>
          ...
          <nav class="nav nav-masthead justify-content-center float-md-end">
            <a class="nav-link fw-bold py-1 px-3 active" aria-current="page" href="dashboard.php">Pedidos</a>
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td class="text-center">
                      <a href="pedidos/ver.php?ID=<?php print $item['ID'] ?>" class="btn btn-danger btn-sm">Detalles</a>
                    </td>
                  </tr>
                  <?php
                    }
